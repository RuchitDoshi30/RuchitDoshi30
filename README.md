...
## 💫 About Me
🔹 Aspiring Data Analyst with strong focus on SQL analytics, data cleaning, and business metrics.  
🔹 Interested in FinTech analytics — payments, customer behavior, risk indicators, and transaction insights.  
🔹 Currently building projects around data analysis workflows (SQL analysis, Python data processing, dashboards).  
🔹 Goal: Build analytical systems and insights supporting financial decisions and product strategy.  
...
- Python for Data Analysis (Pandas, Data Cleaning, Aggregations)
- Business Metrics & KPI Analysis (Retention, Revenue, Cohorts)
- Power BI Dashboards for FinTech Data Insights
- Data Modeling Basics (Fact & Dimension Tables)
